...
public class Function1 {
	...
	public static void main(String[] args) {
		...
		//static function can only call static variables and static methods.
	 ...
	 * 
	 * int sum=a+b; //you need to return integer value you can give anything 10 but
	 * sum is ok for that return sum;
	 * 
	 * }
	 */
	/*
	 * public static void sum(int a, int b, int c) { int sum=a+b+c;
	 * System.out.println(sum); }
	 */
