...
public class BAFRoundTripTwoPass {
...
public void login()
{
	...
	WebElement Round=dr.findElement(By.xpath("//input[@value='roundtrip']"));
	...
	//Return
		...
		WebElement Ret=dr.findElement(By.xpath("//input [@value='Pangea Airlines$632$282$16:37']"));
	...
	//passenger2
		WebElement Fname2=dr.findElement(By.name("passFirst1"));
		Fname2.sendKeys("Sharukh");
		
		WebElement Lname2=dr.findElement(By.name("passLast1"));
		Lname2.sendKeys("Khan");
		
		WebElement Meal1=dr.findElement(By.name("pass.1.meal"));
